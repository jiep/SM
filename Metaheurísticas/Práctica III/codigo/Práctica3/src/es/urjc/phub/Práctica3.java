...
public class Práctica3 {
	...
	public static void main(String args[]) {
		...
		// System.out.println("Solución inicial: " +
		// Arrays.toString(sol_ini.getSolucion()));
		// System.out.println("Matriz de adyacencia: " +
		// Arrays.deepToString(sol_ini.getMatrizAdyacencia()));
		// System.out.println("Función objetivo: " +
		// df.format(sol_ini.getObjetivo()));
		// System.out.println();
		//
		// for (Enfriamiento.TIPOS_ENFRIAMIENTO tipo :
		// Enfriamiento.TIPOS_ENFRIAMIENTO.values()) {
		//
		// if(tipo == TIPOS_ENFRIAMIENTO.DESCENSO_GEOMETRICO) alpha =
		// alpha_geometrico;
		// if(tipo == TIPOS_ENFRIAMIENTO.LUNDIyMEES) alpha = beta;
		//
		// Solución s = recocidoSimulado(tipo, sol_ini, instancia, temp_ini,
		// nrep, alpha, tiempo);
		//
		// System.out.println("---Solución con recocido simulado de tipo de
		// enfriamiento " + tipo);
		// System.out.println("Solución tras recocido simulado: " +
		// Arrays.toString(s.getSolucion()));
		// System.out.println("Matriz de adyacencia: " +
		// Arrays.deepToString(s.getMatrizAdyacencia()));
		// System.out.println("Función objetivo: " +
		// df.format(s.getObjetivo()));
		// System.out.println();
		//
		...
		// for(int i = 0; i <= 10; i++){
		// beta = Math.pow(10, -i);
		// Solución s = recocidoSimulado(TIPOS_ENFRIAMIENTO.LUNDIyMEES, sol_ini,
		// instancia, temp_ini, nrep, beta, tiempo);
		//
		// System.out.println("---Solución con recocido simulado de tipo Lundi y
		// Mees con parámetro " + beta);
		// System.out.println("Solución tras recocido simulado: " +
		// Arrays.toString(s.getSolucion()));
		// System.out.println("Matriz de adyacencia: " +
		// Arrays.deepToString(s.getMatrizAdyacencia()));
		...
		// + TimeUnit.MINUTES.convert(fin_fecha.getTime() -
		// inicio_fecha.getTime(), TimeUnit.MILLISECONDS)
		// + " minutos");
		//
		...
		for (InstanciaPHub instancia : instancias) {
			...
			Solución s = recocidoSimulado(TIPOS_ENFRIAMIENTO.LUNDIyMEES, sol_ini, instancia, temp_ini, nrep, beta,
					tiempo);

			System.out.println(
					"---Solución con recocido simulado de tipo de enfriamiento Lundi y Meer con parámetro 0.01");
		...
		// csv += "\n";
		 ...
		 Date fin_fecha = new Date(System.currentTimeMillis());
		 System.out.println("Final: " + fin_fecha);
		 System.out.println();
		 System.out.println("Tiempo total: "
		 + TimeUnit.MINUTES.convert(fin_fecha.getTime() -
		 inicio_fecha.getTime(), TimeUnit.MILLISECONDS)
